...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col m7">
            ...
            <div class="row underline">
                <div class="col m12">
                <h5 class="promo-caption">关于此房源</h5>
                <p class="light" style="word-wrap:break-word;font-size: 20px">XXXXXXXXXXXaisdjoaisjdoijasojdoasjdoajsdjoaisjdoiajsoidjaosijdoasdjioajoidjsaodjoasjdoiasoidjoaisjdoiajsoidjoasijdoiasjodioasjdoiiasjoidjs</p>
                </div>
            </div>
